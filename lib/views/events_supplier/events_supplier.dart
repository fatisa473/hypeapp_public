...
class EventsSupplierPage extends StatefulWidget {
  _EventsSupplierPage createState() => _EventsSupplierPage();
}

class _EventsSupplierPage extends State<EventsSupplierPage> {
  Future<List> getDataEvent() async {
    final response = await http.post(
        Uri.parse(
            "https://hypeapp1.herokuapp.com/eventsproducts_php/getdataevent.php"),
        body: {'idDato': "1"});
                  ...
                  onTap: () {
                    if (!selectedIndexList.contains(i) ||
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              FoundEventoTile(list: list, index: i),
                        ),
                      );
                    }
                    /*else {
