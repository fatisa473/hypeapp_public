...
import 'package:hypeapp/views/events_supplier/map_supplier.dart';
import 'package:image_picker/image_picker.dart';

import '../supplier.dart';
import '../various.dart';
import 'crud_event.dart';
import 'editar_event.dart';
import 'events_supplier.dart';

class FoundEventoTile extends StatefulWidget {
  List list;
  int index;

  FoundEventoTile({required this.list, required this.index});

  @override
  _FoundEventoTile createState() => _FoundEventoTile();
}

class _FoundEventoTile extends State<FoundEventoTile> {
  //fecha
  ...
  void deleteData() {
    ...
    http.post(url, body: {'idEvento': widget.list[widget.index]['idEvento']});
  }
      ...
      children: <Widget>[
        ...
        TextFormField(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => MapSupplier()),
            );
          },
          readOnly: true,
          controller: nameController,
