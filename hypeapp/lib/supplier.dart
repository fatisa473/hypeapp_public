...
import 'package:hypeapp/views/events_supplier/events_supplier.dart';
...
class _BottomNavBarState extends State<SupplierPage> {
    ...
    setState(() {
      ...
      switch (index) {
        case 0:
          ...
          break;
        case 1:
          appBarTitle = _appBarTitle("Eventos");
          break;
        case 2:
          ...
          break;
        case 3:
          appBarTitle = _appBarTitle("Tus Productos y Servicios");
          break;
        case 4:
